...
DATASET_A_RESULT_DIR = RESULTS_DIR / 'time-window'
DATASET_A_PLOTS_DIR = DATASET_A_RESULT_DIR / 'plots'
DATASET_B_RESULT_DIR =  RESULTS_DIR / 'packet-window'
DATASET_B_PLOTS_DIR = DATASET_B_RESULT_DIR / 'plots'

METRICS_DIR = RESULTS_DIR / 'metrics'
PLOTS_DIR = RESULTS_DIR / 'plots'

TELEGRAM_IPS = { '149.154.167.99', '2001:67c:4e8:f004::9' }